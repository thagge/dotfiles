...
vim.keymap.set("n", "<leader>-", require("oil").toggle_float, { desc = "Open parent directory in floating window" }) -- opens parent dir in floating window over current active window
