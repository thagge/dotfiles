vim.pack.add({ "https://github.com/hrsh7th/cmp-nvim-lsp", "https://github.com/neovim/nvim-lspconfig" },
	{ confirm = false })
vim.pack.add({ { src = "https://github.com/antosha417/nvim-lsp-file-operations", data = { config = true } } },
	{ confirm = false })
